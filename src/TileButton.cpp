...
TileButton::TileButton(Type type,int PosX,int PosY,int posW,int posH,std::string buttonLabel,int TextSize)
...
void TileButton::SetTileObject(TileObject &NewSelectedObject)
{
 TileObjectSelected = &NewSelectedObject;
}
